...
namespace dolfin
{
  class MPMMaterial
  {
    public:
      ...
      std::vector<double>        get_u_y()            {return v_y;};
      std::vector<double>        get_u_z()            {return w_z;};
      ...
      std::vector<double>        get_u_y_star()       {return v_y_star;};
      std::vector<double>        get_u_z_star()       {return w_z_star;};
