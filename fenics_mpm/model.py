  ...
  def mpm(self, t_start, t_end, cb_ftn=None):
    ...
    * :func:`~model.Model.advect_material_particles`
    ...
    while self.t < t_end:
      ...
      text  = '\r' + text0 + text1 + text2 + text3 + text4
    ...
    # always get the material properties back from C++ land : 
