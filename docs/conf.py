# -*- coding: utf-8 -*-
#
# fenics_mpm documentation build configuration file, created by
...
project = u'fenics_mpm'
copyright = u'2017, Evan M. Cummings'
...
htmlhelp_basename = 'fenics_mpmdoc'
...
latex_documents = [
    (master_doc, 'fenics_mpm.tex', u'fenics\\_mpm Documentation',
...
man_pages = [
    (master_doc, 'fenics_mpm', u'fenics_mpm Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'fenics_mpm', u'fenics_mpm Documentation',
     author, 'fenics_mpm', 'One line description of project.',
     'Miscellaneous'),
]
