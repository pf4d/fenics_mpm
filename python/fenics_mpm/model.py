...
import fenics_mpm.cpp          as mpm_module
...
class Model(object):
	...
	* ``self.materials`` -- an initially empty :py:obj:`list` of materials
	...
	def __init__(self, out_dir, grid_model, dt, verbose=True):
		...
		self.mpm_cpp = mpm_module.MPMModel(self.grid_model.Q._cpp_object,
		                                   self.grid_model.dofs,
		                                   dt, verbose)
		# intialize the cell diameter :
		self.mpm_cpp.set_h(self.grid_model.h.vector())

		# intialize the cell volume :
		self.mpm_cpp.set_V(self.grid_model.Ve.vector())
